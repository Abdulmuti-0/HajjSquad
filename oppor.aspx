<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="oppor.aspx.cs" Inherits="oppor" %>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="panel">
                            <div class="panel-footer">
                                ...
                                <h3 class="title text-center"><span class="icon"><i class="fa fa-bookmark"></i></span> <%#Eval("Name") %></h3>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 margin-bottom-30">
                                    ...
                                    <div class="col-md-6 text-right"><asp:LinkButton ID="lbtnEnroll" runat="server" 
                                        OnClick="lbtnEnroll_Click" class="btn btn-success" CommandName='<%#Eval("Id") %>' >Enroll Now</asp:LinkButton></div>
                                </div>
                            </div>
                        </div>
